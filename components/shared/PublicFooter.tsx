    ...
    return (
      ...
      opacity-60">
            ...
            <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 px-6">
                ...
                <div>
                    <h2 className="text-2xl font-bold mb-4 flex items-center gap-2"><span className="text-blue-500">V</span>ibent</h2>
                    <p className="opacity-70">Social Link</p>
                    <div className="flex gap-3 mt-3">
                        <div className="p-2 bg-white/10 rounded-lg">F</div>
                        <div className="p-2 bg-white/10 rounded-lg">I</div>
                        <div className="p-2 bg-white/10 rounded-lg">X</div>
                    </div>
                </div>

                <div>
                    <h3 className="text-lg font-semibold mb-2">Venue Address</h3>
                ...
                <div>
                    ...
                    <p className="opacity-70 mb-3">Sign up for weekly updates</p>
                    <input type="email" placeholder="Your email address" className="w-full px-4 py-2 rounded-lg bg-white/10" />
